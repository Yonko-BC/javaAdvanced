...
public class OwnerController implements Initializable {
    ...
    public void uploadData(ActionEvent actionEvent) {
        ownerService.readFromStyleSheetAndInsertInDatabase("src/main/resources/files/ownerInfo.xlsx");
    }

    @FXML
    private void openEditOwnerForm(Owner owner) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/EditOwner.fxml"));
            Parent parent = loader.load();
            EditOwnerController editOwnerController = loader.getController();
            editOwnerController.setOwner(owner);
            editOwnerController.setOwnerService(ownerService);
            System.out.println(owner);
            Scene scene = new Scene(parent);
            Stage stage = new Stage();
            stage.setScene(scene);
    ...
    @FXML
    private void openExportFile() throws Exception{
        ownerService.writingExcelFile(ownerList);
    }
